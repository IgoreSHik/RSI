 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://cw1/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http:/cw1/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://cw1/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cw1/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
