...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://cw1/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://cw1/", "getHelloWorldAsString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cw1/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cw1/", name = "getHelloWorldAsString")
